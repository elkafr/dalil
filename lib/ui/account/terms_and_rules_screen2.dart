...
class TermsAndRulesScreen2 extends StatefulWidget {
  @override
  _TermsAndRulesScreen2State createState() => _TermsAndRulesScreen2State();
}

class _TermsAndRulesScreen2State extends State<TermsAndRulesScreen2> {
...
@override
  Widget build(BuildContext context) {
    ...
    final appBar = AppBar(
      ...
      title:    Text("لماذا دليل المهنيين المحترفين؟",
