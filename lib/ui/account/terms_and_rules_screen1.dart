...
class TermsAndRulesScreen1 extends StatefulWidget {
  @override
  _TermsAndRulesScreen1State createState() => _TermsAndRulesScreen1State();
}

class _TermsAndRulesScreen1State extends State<TermsAndRulesScreen1> {
