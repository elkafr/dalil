...
import 'package:dalil/models/ad_details.dart';
import 'package:dalil/networking/api_provider.dart';
import 'package:dalil/providers/ad_details_provider.dart';
import 'package:dalil/providers/auth_provider.dart';
import 'package:dalil/providers/favourite_provider.dart';
import 'package:dalil/ui/chat/chat_screen.dart';
import 'package:dalil/ui/seller/seller_screen.dart';
import 'package:dalil/ui/section_ads/section_ads_screen.dart';
...
import 'package:dalil/ui/ad_details/widgets/slider_images.dart';
import 'package:dalil/providers/home_provider.dart';
import 'package:dalil/ui/comments/comment_bottom_sheet.dart';
import 'package:dalil/ui/comment/comment_screen.dart';
...
import 'package:dalil/models/comments.dart';
import 'package:dalil/providers/comment_provider.dart';
import 'package:dalil/providers/home_provider.dart';
import 'package:flutter/material.dart';
import 'package:flutter_spinkit/flutter_spinkit.dart';
import 'package:dalil/custom_widgets/custom_text_form_field/custom_text_form_field.dart';
...
import 'package:dalil/models/chat_msg_between_members.dart';
import 'package:dalil/networking/api_provider.dart';
import 'package:dalil/providers/auth_provider.dart';
import 'package:dalil/providers/chat_provider.dart';
import 'package:dalil/ui/chat/widgets/chat_msg_item.dart';
import 'package:dalil/utils/app_colors.dart';
import 'package:dalil/utils/commons.dart';
import 'package:dalil/utils/error.dart';
import 'package:dalil/utils/urls.dart';
        ...
        (_homeProvider.omarKey=="1")?GestureDetector(
          child: CustomButton(
            ...
            onPressedFunction: () async{
              ...
              final results = await _apiProvider
                  .post("https://arab-zone.net/api/report999" +
                  "?api_lang=${_authProvider.currentLang}", body: {
               // "report_user": _authProvider.currentUser.userId,
                "report_gid": widget.ad.adsId,
                //"report_value": reportValue,
              ...
              child: Row(
                children: <Widget>[
                 ...
                 IconButton(
                  ...
                  IconButton(
                    onPressed: (){
                        Share.share("http://arab-zone.net/site/show/" + widget.ad.adsId,
